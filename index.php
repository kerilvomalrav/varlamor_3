...
$ult= implode(',',$_POST['ultimate']);
// Подготовленный запрос. Не именованные метки.
try {
  $stmt = $db->prepare("INSERT INTO application SET name = ?, email = ?, date = ?, sex = ?, konech = ?, ultimate = ?, bio = ?");
  $stmt -> execute([$_POST['name'],$_POST['email'],$_POST['date'],$_POST['radio-group-1'],$_POST['radio-group-2'],$ult,$_POST['bio']]);
}
